...
This is the third in a series of three courses about Red Hat Developer Hub (RHDH).
This course teaches you how to build effective self-service developer portals using RHDH.
...
```
    $ git clone git@github.com:RedHatQuickCourses/devhub-build.git
```
...
12. Verify that your changes have been published to the production GitHub pages website at https://redhatquickcourses.github.io/devhub-build

## Problems and Feedback
If you run into any issues, report bugs/suggestions/improvements about this course here - https://github.com/RedHatQuickCourses/devhub-build/issues