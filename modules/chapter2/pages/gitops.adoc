...
When importing ArgoCD `Application` resources into RHDH, you must ensure that you have an `argocd/app-name` annotation in your catalog YAML descriptor files that match the name of the ArgoCD `Application` resource.
