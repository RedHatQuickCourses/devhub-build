...
NOTE: The hands-on labs for this course have been tested on *RHDH v1.4*. The labs should mostly work in minor update releases of RHDH. If you encounter any issues, please open a GitHub issue in the course repository.
