...
You do not have to configure anything extra for search. RHDH automatically indexes your documentation and enables rapid search find functionality for your developers.
